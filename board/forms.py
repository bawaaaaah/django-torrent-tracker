...
from board.models import Category, UserSettings
...
class UserSettingsForm(forms.ModelForm):
    ...
    frontpage_filters = forms.MultipleChoiceField(required=False,
    ...
    def clean_frontpage_filters(self):
        frontpage_filters = [cat for cat in (Category.objects.get(pk=id) for id in self.cleaned_data['frontpage_filters']) if cat.can_read(self.user)]
