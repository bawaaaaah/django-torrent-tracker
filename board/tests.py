...
class TestBasicViews(TestCase):
	...
	def test_new_post(self):
		...
		r = c.post(reverse('board_new_thread', args=(gd.id,)),{
			'subject': 'Test topic',
			'post': 'Lorem ipsum dolor sit amet.',
		})
		self.assertRedirects(r, reverse('board_thread', args=(1,)))
...
class TestCategoryPermissions(TestCase):
	...
	def runTest(self):
		...
		# Create a new thread
		r = c.post(reverse('board_new_thread', args=(self.category.id,)),{
			'subject': 'Test topic',
			'post': 'Lorem ipsum dolor sit amet.',
		})
		if self.category.can_create_thread(user):
			...
			self.assertRedirects(r,
				reverse('board_thread', args=(thread_id,)),
